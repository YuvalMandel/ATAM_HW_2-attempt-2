...
int main ()
{
    ...
    // my_vec.push_back("0xc5"); // Warning to anyone reading this - don't try to test this opcode.
	my_vec.push_back("0xd4");
	my_vec.push_back("0xd5");
	my_vec.push_back("0xd6");
	my_vec.push_back("0xea");
	my_vec.push_back("0x040f");
	my_vec.push_back("0x0a0f");
	my_vec.push_back("0x0e0f");
	// my_vec.push_back("0x0f0f"); // Warning to anyone reading this - don't try to test this opcode.
	...
	my_vec.push_back("0x3f0f");
	my_vec.push_back("0x7a0f");
	my_vec.push_back("0x7b0f");
	my_vec.push_back("0xa60f");
	my_vec.push_back("0xa70f");
	my_vec.push_back("0xff0f");
	...
	if( what_to_do(it) == 0 )
	{
		// myfile2 << "Illegal instruction"<<std::endl;
        }
	else
	{
